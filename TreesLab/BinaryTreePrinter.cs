...
//Credit to Ivan Stoev in https://stackoverflow.com/questions/36311991/c-sharp-display-a-binary-search-tree-in-console
//Minor modifications made to fit my Node class
namespace TreesLab
{
    public static class BinaryTreePrinter
    {
        ...
        public static void Print(this Node root, string textFormat = "0", int spacing = 1, int topMargin = 2, int leftMargin = 2)
        {
            ...
            {
                var item = new NodeInfo { Node = next, Text = next.Data.randomValue.ToString(textFormat) };
                if (level < last.Count)
                {
